...
module.exports = async function (taskArgs, hre) {
    ...
    console.log(`✅ Message Sent [${hre.network.name}] sendTokens() to OFT @ LZ chainId[${remoteChainId}] toAddress:[${toAddress}]`)
    console.log(` tx: ${tx.transactionHash}`)
    console.log(`* check address [${toAddress}] on the destination chain, in the ERC20 transaction tab !"`)
}
